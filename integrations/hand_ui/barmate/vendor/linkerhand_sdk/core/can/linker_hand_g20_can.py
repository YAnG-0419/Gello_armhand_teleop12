...
class LinkerHandG20Can:
    def __init__(self, can_channel="can0", baudrate=1000000, can_id=0x28, yaml=""):
        ...
        (
            ...
            self.last_index_pos,
            self.last_ring_pos,
            self.last_middle_pos,
            self.last_little_pos,
    ...
    def get_temperature(self):
        """API接口:获取手指温度"""
        joint_temperature = [
            self.get_thumb_temperature(),
            self.get_index_temperature(),
            self.get_middle_temperature(),
            self.get_ring_temperature(),
    ...
    def joint_state_to_cmd_state(self, list):
        ...
        try:
            for i, finger_data in enumerate(list):
                if i == 0:
                    original[10] = finger_data[0]
                    original[5] = finger_data[1]
                    original[0] = finger_data[2]
                    original[15] = finger_data[5]
                if i == 1:
                    original[6] = finger_data[0]
                    original[1] = finger_data[2]
                    original[16] = finger_data[5]
                if i == 2:
                    original[7] = finger_data[0]
                    original[2] = finger_data[2]
                    original[17] = finger_data[5]
                if i == 3:
                    original[8] = finger_data[0]
                    original[3] = finger_data[2]
                    original[18] = finger_data[5]
                if i == 4:
                    original[9] = finger_data[0]
                    original[4] = finger_data[2]
                    original[19] = finger_data[5]
            return original
        except Exception as e:
            print("error", e)
            return [-1] * 20
