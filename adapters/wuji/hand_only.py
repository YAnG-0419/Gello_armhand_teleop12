#!/usr/bin/env python3
"""Run MANUS-to-Wuji hand teleoperation without GELLO or FR3 arms."""
...
from .pipeline import MODELS, WujiHandPipeline  # noqa: E402
...
def run(args: argparse.Namespace) -> int:
    ...
    print("Wuji HAND-ONLY mode: GELLO, FR3, Docker, and arm control are not started.")
    for side in sides:
